...
return [
    ...
    'attributes' => [
        ...
        "prerequisites" => "مهارت های پیش نیاز",
        "labor_market" => "بازار کار",
        "skill" => "مهارت های کسب شده",
        "chart" => "چارت",
        "start_date" => "تاریخ شروع",
        "end_date" => "تاریخ پایان",
        "class_time" => "زمان برگزاری کلاس",
        "course_length" => "مدت کلاس",
        "cost" => "هزینه کلاس",
        "capacity" => "ظرفیت",
        "amount" => "مبلغ",
        "refid" => "شماره پیگیری",
